...
const Blogs = () => {
    return (
        <div className="container">
            <h2 className="mt-3 mb-3" style={{fontFamily: "Rockwell"}}>Difference between javascript and nodejs:</h2>
            <Table striped bordered hover>
              ...
              <h3 style={{fontFamily: "Rockwell"}} className="mt-5 mb-3"> Differences between sql and nosql databases:</h3>
              <Table striped bordered hover>
              <thead>
                <tr>
                  <th>S.No</th>
            ...
            <h3 className="mt-5" style={{fontFamily: "Rockwell"}}>What is the purpose of jwt and how does it work</h3>
            ...
            <p>JWTs differ from other web tokens in that they contain a set of claims. Claims are used to transmit information between two parties. What these claims are depends on the use case at hand. For example, a claim may assert who issued the token, how long it is valid for, or what permissions the client has been granted. <br />
               A JWT is a string made up of three parts, separated by dots (.), and serialized using base64. In the most common serialization format, compact serialization, the JWT looks something like this: <i>xxxxx.yyyyy.zzzzz.</i> <br />
              ...
              There are no mandatory claims for a JWT, but overlaying standards may make claims mandatory. <i>For example</i>, when using JWT as bearer access token under OAuth2.0, iss, sub, aud, and exp must be present. some are more common than others. <br />
              ...
              <strong>JWT Example: OAuth Bearer Tokens</strong>
              <br />
